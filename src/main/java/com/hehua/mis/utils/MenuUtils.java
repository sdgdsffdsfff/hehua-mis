...
public class MenuUtils extends TagSupport {
    ...
    public static String getFirstLevelMenu(String menuKey) throws CreateSessionException {
        ...
        JSONMenu menu = authService.getMenu(menuKey, HttpSession.session(MisConstants.CURRENT_USER));
        if (menu != null)
    ...
    public static String getSecondLevelMenu(String menuKey) throws CreateSessionException {
        ...
        JSONMenu menu = authService.getMenu(menuKey, HttpSession.session(MisConstants.CURRENT_USER));
        if (menu != null)
            return "<div class=\"col-md-1\"><a class=\"btn btn-block\"  id = '" + menuKey + "' href= '" + menu.getUrl() + "'" + ">" + menu.getName() + "</a></div>\n";
        return "";
    }
    ...
    public static String getSecondLevelMenu(String menuKey, String otherAttr) throws CreateSessionException {
        ...
        if (menu != null) {
            return "<div class=\"col-md-1\"><a class=\"btn btn-block\" id=\"" + menuKey + "\" href=\"" + menu.getUrl() + "\"" + otherAttr + ">" + menu.getName() + "</a></div>\n";
        }
        return "";
    }
    ...
    public static String getSecondLevelMenu(String menuKey, String otherAttr, String leftSpace) throws CreateSessionException {
        ...
        if (StringUtils.isEmpty(otherAttr) && StringUtils.isNotEmpty(leftSpace)) {
            ...
            JSONMenu menu = authService.getMenu(menuKey, HttpSession.session(MisConstants.CURRENT_USER));
            if (menu != null)
                return "<div class=\"col-md-1\" style=\"margin-left: " + leftSpace + ";\"><a class=\"btn btn-block\" id=\"" + menuKey + "\" href=\"" + menu.getUrl() + "\">" + menu.getName() + "</a></div>\n";
        ...
        otherAttr = otherAttr == null ? "" : otherAttr;
        if (menu != null) {
            return "<div class=\"col-md-1\" style=\"margin-left: " + leftSpace + ";\"><a class=\"btn btn-block\" id=\"" + menuKey + "\" href=\"" + menu.getUrl() + "\"" + otherAttr + ">" + menu.getName() + "</a></div>\n";
        }
        return "";
    }
    ...
    public static JSONMenu getMenu(String menuKey) throws CreateSessionException {
         AuthService authService = AuthServiceImpl.getAuthService();
        return authService.getMenu(menuKey,HttpSession.session(MisConstants.CURRENT_USER));
    }
}
