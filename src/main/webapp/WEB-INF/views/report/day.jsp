...
<jsp:include page="/template/menus.jsp">
    ...
    <jsp:param name="L2" value="report_day"></jsp:param>
</jsp:include>
<div class="container">
    ...
    <div class="highlight">
        ...
        <c:forEach var="channel" items="${summaryChannelDayList}" varStatus="i">
...
<script>
var xaxisOrder = [<c:forEach var="record" items="${xaxis_day}" varStatus="i">"${record}"<c:if test="${!i.last}">,</c:if></c:forEach>];
...
var userSegmentObject = {
    <c:forEach var="record" items="${summaryUserSegmentDayList}" varStatus="i">
    "${record.dt}_${record.channelid}": {
        usercount: ${record.usercount},
